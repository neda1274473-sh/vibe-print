"""
Pre-hardware verification Part 1 — runs only the first 2 natural-language requests
...
# Test requests — ONLY first 2 for Part 1
REQUESTS = [
...
def main():
    ...
    # Save raw results
    out_path = Path("verification_part1_results.json")
